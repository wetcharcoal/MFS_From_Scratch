...
import { idlFactory } from './aseed_frontend.did.js';
export { idlFactory } from './aseed_frontend.did.js';
 ...
 * @return {import("@icp-sdk/core/agent").ActorSubclass<import("./aseed_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the aseed_frontend canister
 * @type {import("@icp-sdk/core/agent").ActorSubclass<import("./aseed_frontend.did.js")._SERVICE>}
 */
