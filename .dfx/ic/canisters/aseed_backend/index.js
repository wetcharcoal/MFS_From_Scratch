...
import { idlFactory } from './aseed_backend.did.js';
export { idlFactory } from './aseed_backend.did.js';
 ...
 * @return {import("@icp-sdk/core/agent").ActorSubclass<import("./aseed_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the aseed_backend canister
 * @type {import("@icp-sdk/core/agent").ActorSubclass<import("./aseed_backend.did.js")._SERVICE>}
 */
